              ...
              {submitted ? (
                ...
                <Box component="form" onSubmit={handleSubmit}>
                  ...
                  <Grid container spacing={2.5}>
                    ...
                    <Grid size={{ xs: 12, sm: 6 }}>
                      <TextField select required fullWidth label="Subject" value={form.subject} onChange={e => setForm(p => ({ ...p, subject: e.target.value }))}>
                    ...
                    <Grid size={{ xs: 12 }}>
                      <TextField required fullWidth multiline rows={4} label="Message" value={form.message} onChange={e => setForm(p => ({ ...p, message: e.target.value }))} />
                    </Grid>
                    <Grid size={{ xs: 12 }}>
